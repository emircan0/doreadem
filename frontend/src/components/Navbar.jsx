            ...
            <div className="w-full py-4 md:py-6 bg-white">
                <div className="container mx-auto px-6 lg:px-12 flex items-center justify-between gap-8 md:gap-12">
                    ...
                    <button
                        ...
                        className="md:hidden p-2 text-lux-dark hover:text-lux-accent transition-colors"
                    >
                    ...
                    <div className="flex-shrink-0 flex flex-col items-center">
                        <Link to="/" className="flex flex-col items-center group">
                            <span 
                                className="text-2xl md:text-3xl lg:text-4xl font-serif text-lux-dark tracking-tighter uppercase font-bold group-hover:text-lux-accent transition-colors"
                            ...
                            <div className="flex items-center gap-2 mt-0.5">
                                ...
                                <span className="text-[9px] md:text-[10px] font-bold text-lux-accent tracking-[0.2em] uppercase">Premium Çiçek Butiği</span>
                                <div className="h-[1px] w-4 md:w-8 bg-lux-accent opacity-30"></div>
                            </div>
                        </Link>
                    </div>
                    ...
                    <div className="flex items-center gap-4 md:gap-8 flex-1 justify-end">
                        <Link to="/favoriler" className="flex flex-col items-center group">
                            <div className="p-2.5 rounded-full hover:bg-gray-50 transition-all border border-transparent hover:border-gray-100">
                        ...
                        <button onClick={() => setIsCartOpen(true)} className="flex flex-col items-center group cursor-pointer">
                            <div className="relative p-2.5 rounded-full hover:bg-gray-50 transition-all border border-transparent hover:border-gray-100">
